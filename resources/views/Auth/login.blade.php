...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{asset('images/logos/seodashlogo.png')}}" />
            ...
            <div class="card mb-0">
              <div class="card-body">
                <a href="./index.html" class="text-nowrap logo-img text-center d-block py-3 w-100">
                  <img src="{{asset('images/logo-bappeda_new.png')}}" alt="" style="height:auto; display: block; margin-left: auto; margin-right: auto; width: 70%;">
                </a>
